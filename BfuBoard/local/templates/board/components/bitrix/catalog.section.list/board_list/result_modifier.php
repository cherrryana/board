...
if (0 < $arResult['SECTIONS_COUNT'])
{
	...
	if ($boolPicture || $boolDescr)
	{
		...
		while ($arSection = $rsSections->GetNext())
		{
            ...
            $arResult['SECTIONS'][$key]['TEAM'] = $arSection['UF_TEAM'];
			if ($boolPicture)
			{
...
foreach ($arResult['SECTIONS'] as $key => $arSection)
{
   if(in_array($arSection['ID'],$allowedTeamBoards)){
       $actualSections[] = $arSection;
   }
}
$arResult['SECTIONS'] = $actualSections;
?>